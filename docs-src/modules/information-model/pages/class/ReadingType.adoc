...
| https://cim.ucaiug.io/ns#ReadingType[`cim:ReadingType`]
...
| `1..*`
| `AggregateKind` 
//| +++Salient attribute of the reading data aggregated from individual endpoints. This is mainly used...+++
...
| `1..*`
| `FlowDirectionKind` 
//| +++Flow direction for a reading where the direction of flow of the commodity is important (for...+++
