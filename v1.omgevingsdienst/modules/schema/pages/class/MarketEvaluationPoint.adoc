...
//| [[slots_table.marketSegment]]<<marketSegment,`marketSegment`>>
| 0..1 +
xref::enumeration/MarketSegment.adoc[`MarketSegment`]
| +++A subgroup of current or potential customers.+++
| _n/a_
...
|===
| URI
| http://modellen.netbeheernederland.nl/dp-meetdata/MarketEvaluationPoint.marketSegment[`vocab:MarketEvaluationPoint.marketSegment`]
| Cardinality
| 0..1
| Type
| xref::enumeration/MarketSegment.adoc[`MarketSegment`]
